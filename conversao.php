			...
			<div>
				<main>
					...
					<form action="" method="get">
						...
						<input type="number" name="valor" id="valor" step="1.0"></input>
						<input type="submit" name="converter" value="Converter"></input>
						<?php
		if (isset($_GET["valor"])) {
			$anos_luz = $_GET["valor"];
			$km = 9460730472580.8;
			...
			<div>
				<main>
					...
					<form action="" method="get">
						...
						<input type="number" name="valor2" id="valor2" step="1.0"></input>
						<input type="submit" name="converter" value="Converter"></input>
					<?php
